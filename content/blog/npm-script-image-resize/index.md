---
title: npm-scriptで画像の一括リサイズを行う
date: "2021-01-08"
description: npm-scriptでsharpを用いて、画像の一括リサイズを行うモジュールの作成方法を紹介します。
tag:
  - node
  - npm-script
---
...
今回はそういった方達を救済する為、`npm-script`で`sharp`を用いて  
...
<script type="application/ld+json">
{
  ...
  "@type": "Article",
  "name": "npm-scriptで画像の一括リサイズを行う",
  "headline": "npm-scriptで画像の一括リサイズを行う",
  "author": {
    "@type": "Person",
    "name": "Daichi Iwamoto"
  },
